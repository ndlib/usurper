...
import FavoriteItem from 'components/Account/Preferences/FavoritesList/FavoriteItem'
...
describe('components/Account/Preferences/FavoritesList/FavoriteItem.js', () => {
  afterEach(() => {
