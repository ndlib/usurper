...
import Search, { SearchContainer } from 'components/Account/Preferences/Search'
import SearchResult from 'components/Account/Preferences/Search/SearchResult'
...
describe('components/Account/Preferences/Search', () => {
  afterEach(() => {
