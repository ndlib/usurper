...
import ManageFavorites, { ManageFavoritesContainer } from 'components/Account/Preferences/ManageFavorites'
import Presenter from 'components/Account/Preferences/ManageFavorites/presenter.js'
...
describe('components/Account/Preferences/ManageFavorites', () => {
  afterEach(() => {
