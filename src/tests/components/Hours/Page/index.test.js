...
describe('components/Hours/Page/Container', () => {
  ...
  it('only renders APIPresenterFactory with hoursEntry slice and PagePresenter', () => {
    expect(enzymeWrapper.
      containsMatchingElement(<APIPresenterFactory status={props.hoursEntry.status } props={{}} presenter={ PagePresenter } />)).
      toBe(true)
  })
