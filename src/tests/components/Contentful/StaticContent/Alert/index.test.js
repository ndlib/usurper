...
import Alert, { mapStateToProps, mapDispatchToProps } from 'components/Contentful/StaticContent/Alert'
...
const setup = (props) => {
  return shallow(<Alert.WrappedComponent {...props} />)
}

const slug = 'sluggyMcSlugger'

describe('components/Contentful/StaticContent/Alert', () => {
  beforeEach(() => {
    props = {
      slug,
      cfStatic: {
